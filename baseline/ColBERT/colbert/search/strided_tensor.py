...
class StridedTensor(StridedTensorCore):
    ...
    def lookup(self, pids, output='packed'):
        # the input pids is the centroidID, and the output is the length of the corresponding itemID and offset
        ...
        if self.use_gpu:
            ...
            # self.tensor is the mapping from the centroidID to the itemID list, it is a 1D array, should combine with length
            # the output is the corresponding itemID
