#!/usr/bin/env python3
#
# pybind documentation build configuration file, created by
...
breathe_projects = {"pybind": ".build/doxygenxml/"}
breathe_default_project = "pybind"
...
latex_documents = [
    (master_doc, "pybind.tex", "pybind Documentation", "Wenzel Jakob", "manual"),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
# latex_logo = 'pybind-logo.png'
