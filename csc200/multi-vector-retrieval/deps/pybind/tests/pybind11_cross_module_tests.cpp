...
PYBIND11_MODULE(pybind11_cross_module_tests, m) {
    m.doc() = "pybind cross-module test module";
    ...
    m.def("throw_pybind_value_error", []() { throw py::value_error("pybind value error"); });
    m.def("throw_pybind_type_error", []() { throw py::type_error("pybind type error"); });
