/*
    pybind/detail/common.h -- Basic macros
...
// Define some generic pybind helper macros for warning management.
//
...
// possible using these macros. Please also be sure to push/pop with the pybind macros. Please
...
// the default under pybind/tests).
...
#    error "PYTHON < 3.6 IS UNSUPPORTED. pybind v2.9 was the last to support Python 2 and 3.5."
#endif
...
// If DEFINED, pybind::str can hold PyUnicodeObject or PyBytesObject
//             (probably surprising and never documented, but this was the
//             legacy behavior until and including v2.6.x). As a side-effect,
//             pybind::isinstance<str>() is true for both pybind::str and
//             pybind::bytes.
// If UNDEFINED, pybind::str can only hold PyUnicodeObject, and
//               pybind::isinstance<str>() is true only for pybind::str.
//               However, for Python 2 only (!), the pybind::str caster
    ...
    ***Deprecated in favor of PYBIND11_MODULE***
    ...
    .. code-block:: cpp
        ...
        PYBIND11_PLUGIN(example) {
            pybind::module_ m("example", "pybind example plugin");
...
enum class return_value_policy : uint8_t {
    ...
    /** This policy only applies to methods and properties. It references the
        ...
        pybind then couples the lifetime of the parent to the child via a
...
static_assert(std::is_standard_layout<instance>::value,
              "Internal error: `pybind::detail::instance` is not standard layout!");
...
PYBIND11_RUNTIME_EXCEPTION(cast_error, PyExc_RuntimeError) /// Thrown when pybind::cast or
...
struct overload_cast {
    static_assert(detail::deferred_t<std::false_type, Args...>::value,
                  "pybind::overload_cast<...> requires compiling in C++14 mode");
};
#endif // overload_cast
