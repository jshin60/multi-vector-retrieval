...
class Indexer:
    ...
    def index(self, name, collection, embedding_filename: str = None, overwrite=False):
        ...
        if index_does_not_exist or overwrite != 'reuse':
            build_index_time, encode_passage_time = self.__launch(collection, embedding_filename)
    ...
    def __launch(self, collection, embedding_filename: str):
        ...
        build_index_time, encode_passage_time = launcher.launch(self.config, collection, embedding_filename, shared_lists, shared_queues)
        return build_index_time, encode_passage_time
