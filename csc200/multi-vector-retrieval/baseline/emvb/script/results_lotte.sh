...
index_path="index/260k_m32_LOTTE_OPQ"


# k = 10
./build/perf_emvb -k 10 -nprobe 4 -thresh 0.4 -out-second-stage 512 -thresh-query 0.5 \
  -n-doc-to-score 4000 -queries-id-file aux_data/lotte/queries_id_lotte.tsv  -alldoclens-path aux_data/lotte/doclens_lotte.npy -index-dir-path $index_path -out-file results_10_lotte.tsv
