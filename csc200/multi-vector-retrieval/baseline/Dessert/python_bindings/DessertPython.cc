    ...
    PYBIND11_MODULE(dessert_py, m) {  // NOLINT
        ...
        py::class_<DocSearch>(
                ...
                .def("add_doc", &DocSearch::addDocument, py::arg("doc_embeddings"),
                     py::arg("doc_id"), py::arg("n_thread") = 64,
                ...
                .def("add_doc", &DocSearch::addDocumentWithCentroids, py::arg("doc_embeddings"),
                     py::arg("doc_id"), py::arg("doc_centroid_ids"), py::arg("n_thread") = 64,
                ...
                .def(
                        ...
                        py::arg("top_k"), py::arg("num_to_rerank") = 8192, py::arg("n_thread") = 1,
                ...
                .def("rerank", &DocSearch::rankDocuments,
                     py::arg("query_embeddings"), py::arg("internal_ids"), py::arg("n_thread") = 1,
