...
def test_pydoc():
    """Pydoc needs to be able to provide help() for everything inside a pybind module"""
    import pydoc

    import pybind11_tests

    assert pybind11_tests.__name__ == "pybind11_tests"
    assert pybind11_tests.__doc__ == "pybind test module"
...
def test_builtin_key_type():
    ...
    Previous versions of pybind would add a unicode key in python 2.
    """
