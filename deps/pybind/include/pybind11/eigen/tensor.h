/*
    pybind/eigen/tensor.h: Transparent conversion for Eigen tensors
...
static_assert(__GNUC__ > 5, "Eigen Tensor support in pybind requires GCC > 5.0");
#endif
...
static_assert(EIGEN_VERSION_AT_LEAST(3, 3, 0),
              "Eigen Tensor support in pybind requires Eigen >= 3.3.0");
...
struct type_caster<Type, typename eigen_tensor_helper<Type>::ValidType> {
    ...
    static handle cast_impl(C *src, return_value_policy policy, handle parent) {
        ...
        switch (policy) {
            ...
            default:
                pybind11_fail("pybind bug in eigen.h, please file a bug report");
        }
