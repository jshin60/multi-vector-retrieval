/*
    pybind/pybind.h: Main header file of the C++11 python
...
protected:
    ...
    void initialize_generic(unique_function_record &&unique_rec,
        ...
        if (rec->is_constructor && !rec->is_new_style_constructor) {
            ...
            PyErr_WarnEx(PyExc_FutureWarning,
                         ("pybind-bound class '" + class_name
                          + "' is using an old-style "
                            "placement-new '"
                          + func_name
                          + "' which has been deprecated. See "
                            "the upgrade guide in pybind's docs. This message is only visible "
    ...
    /// When a cpp_function is GCed, release any memory allocated by pybind
...
// See https://github.com/python/cpython/pull/22670
    ...
    /// Main dispatch logic for calls to functions bound using pybind
...
// in `call.args` all along.
        ...
        auto append_note_if_missing_header_is_suspected = [](std::string &msg) {
            if (msg.find("std::") != std::string::npos) {
                msg += "\n\n"
                       "Did you forget to `#include <pybind/stl.h>`? Or <pybind/complex.h>,\n"
                       "<pybind/functional.h>, <pybind/chrono.h>, etc. Some automatic\n"
                       "conversions are optional and require extra headers to be included\n"
                       "when compiling your pybind module.";
            }
        };
...
public:
    ...
    /** \rst
        ...
        .. code-block:: cpp
            ...
            py::module_ m("example", "pybind example plugin");
    ...
    /** \rst
        ...
        ``overwrite`` should almost always be false: attempting to overwrite objects that pybind
        ...
        if (!type->ht_type.tp_as_buffer) {
            pybind11_fail("To be able to register buffer protocol support for the type '"
                          ...
                          + "' the associated class<>(..) invocation must "
                            "include the pybind::buffer_protocol() annotation!");
        }
...
private:
    ...
    static void dealloc(detail::value_and_holder &v_h) {
        ...
        // If we don't, the Python API will exit with an exception, and pybind will
