# tools/pybind11NewTools.cmake -- Build system for the pybind modules
#
...
if(NOT Python_FOUND AND NOT Python3_FOUND)
  ...
  # If this behavior is not desired, FindPython _before_ pybind.
  if(NOT is_config)
...
if(DEFINED ${_Python}_INCLUDE_DIRS)
  ...
  #
  # This needs to be a target to be included after the local pybind
  # directory, just in case there there is an installed pybind sitting
...
# WITHOUT_SOABI and WITH_SOABI will disable the custom extension handling used by pybind.
...
function(pybind11_add_module target_name)
  ...
  # py::module_local).  We force it on everything inside the `pybind`
