...
Adds the following targets::
    ...
    pybind::pybind - link to headers and pybind
    pybind::module - Adds module links
    pybind::embed - Adds embed links
    pybind::lto - Link time optimizations (manual selection)
    pybind::thin_lto - Link time optimizations (manual selection)
    pybind::python_link_helper - Adds link to Python libraries
    pybind::windows_extras - MSVC bigobj and mp for building multithreaded
    pybind::opt_size - avoid optimizations that increase code size
...
# include pybind's include directory:
...
function(_pybind11_generate_lto target prefer_thin_lto)
  ...
  elseif(CMAKE_CXX_COMPILER_ID MATCHES "IntelLLVM")
    ...
    # WARNING/HELP WANTED: This block of code is currently not covered by pybind GitHub Actions!
    if(WIN32)
      _pybind11_return_if_cxx_and_linker_flags_work(
